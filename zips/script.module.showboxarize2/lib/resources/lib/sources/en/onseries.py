...
class source:
    def __init__(self):
        ...
        self.base_link = 'http://watchseries.bypassed.st/'
        self.search_link = 'http://watchseries.bypassed.st/search/%s' #'http://dwatchseries.to/show/search-shows-json'
        self.search_link_2 = 'http://watchseries.bypassed.st/search/%s'
