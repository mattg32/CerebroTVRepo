...
class source:
    def __init__(self):
        ...
        self.base_link = 'http://watchseries.unblocked.wtf'
        self.search_link = 'http://watchseries.unblocked.wtf/show/search-shows-json'
        self.search_link_2 = 'http://watchseries.unblocked.wtf/search/%s'
