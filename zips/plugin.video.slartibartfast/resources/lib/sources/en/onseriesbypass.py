...
class source:
    def __init__(self):
        ...
        self.base_link = 'https://watchseries.unblocked.ms'
        self.search_link = 'https://watchseries.unblocked.ms/show/search-shows-json'
        self.search_link_2 = 'https://watchseries.unblocked.ms/search/%s'
