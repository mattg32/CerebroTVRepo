...
class navigator:
    def root(self):
        ...
        self.addDirectoryItem('[COLOR gold]VistaTV ShowBox[/COLOR] - Main Menu', 'ShowChangelog', __icon__, 'DefaultFolder.png')
    ...
    def movies(self, lite=False):
        self.addDirectoryItem('[COLOR green]Click Here to Pair[/COLOR] - (Do this once every 4 hours)', 'pair', __icon__, 'DefaultFolder.png')
        self.addDirectoryItem('[COLOR gold]VistaTV ShowBox[/COLOR] - Movies Menu', 'ShowChangelog', __icon__, 'DefaultFolder.png')
    ...
    def tvshows(self, lite=False):
        self.addDirectoryItem('[COLOR green]Click Here to Pair[/COLOR] - (Do this once every 4 hours)', 'pair', __icon__, 'DefaultFolder.png')
        self.addDirectoryItem('[COLOR gold]VistaTV ShowBox[/COLOR] - TV Menu', 'ShowChangelog', __icon__, 'DefaultFolder.png')
