...
def check4update():
	...
	html = client.request('http://vistatv.me/buildrepo/addons.xml')
	...
	if c_version2 < o_version2:
		update = 'http://vistatv.me/buildrepo/zips/plugin.video.vistatvshowbox/plugin.video.vistatvshowbox-%s.zip'%o_version
